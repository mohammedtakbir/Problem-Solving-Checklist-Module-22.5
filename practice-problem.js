...
const feet = 23;
const printInches = feetToInch(feet);
console.log(printInches, 'Feet'); */
...
const centimeters = 400;
const printMeter = centimeterToMeter(centimeters);
console.log(printMeter, 'Meter'); */
...
function paperRequirements(firstBookCopy, secondBookCopy, thirdBookCopy){
    ...
    const firstBookPageNeeded = firstBookCopy * firstBookPage;
    const secondBookPageNeeded = secondBookCopy * secondBookPage;
    const thirdBookPageNeeded = thirdBookCopy * thirdBookPage;
    const totalPageNeeded = firstBookPageNeeded + secondBookPageNeeded + thirdBookPageNeeded;
    return totalPageNeeded;
}

const copyOfFirstBook = 1;    
const copyOfSecondBook = 1;    
const copyOfThirdBook = 1;    
const printAllPages = paperRequirements(copyOfFirstBook, copyOfSecondBook, copyOfThirdBook);
console.log(printAllPages);
...
const friendsArray = ['abul', 'kabul', 'habul', 'terabul', 'khabul', 'jabul'];
const largestName = bestFriend(friendsArray);
...
const numberArray = [45, 34, 10, 65 ,34, -56, 29, 10];
const positiveNumbers = positive(numberArray);
